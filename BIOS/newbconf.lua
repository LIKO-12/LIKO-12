--This file is responsible for mounting the peripherals and connecting them with each other,
--It loads the user customizable config.json file to tweak some of the peripherals properties.
...
_ScreenWidth, _ScreenHeight = 192, 128
...
local GPU, GPUKit = assert(P("GPU","GPU",{
  ...
  _LIKO_W = _ScreenWidth,
  _LIKO_H = _ScreenHeight,
