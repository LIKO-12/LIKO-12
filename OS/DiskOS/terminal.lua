...
cam("translate",0,3) color(13) print("D",false) color(7) print("isk",false) color(13) print("OS",false) color(7) cam("translate",0,-1) print("  0.6") editor.editorsheet:draw(60,(fw+1)*6+2,fh+3) flip() sleep(0.5) cam()
...
local function checkCursor()
  ...
  rect(cx*(fw+1)-3,blink and cy*(fh+2)+2 or cy*(fh+2)+1,fw+1,blink and fh or fh+2,false,blink and 5 or 1) --The blink
end
