...
local apiloader = fs.load("GameDiskOS:/System/api.lua")
...
addLibrary("GameDiskOS:/Libraries/lume.lua","lume")
addLibrary("GameDiskOS:/Libraries/middleclass.lua","class")
addLibrary("GameDiskOS:/Libraries/bump.lua","bump")
addLibrary("GameDiskOS:/Libraries/likocam.lua","likocam")
addLibrary("GameDiskOS:/Libraries/JSON.lua","JSON")

local helpersloader, err = fs.load("GameDiskOS:/Libraries/diskHelpers.lua")
