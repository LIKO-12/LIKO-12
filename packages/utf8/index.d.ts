...
interface UTF8 {
     ...
     */
    char(this: void, ...args: Array<number>): string;
     ...
     */
    codepoint(this: void, s: string, i?: number, j?: number): any;
     ...
     */
    len(this: void, s: string, i?: number, j?: number): number;
     ...
     */
    offset(this: void, s: string, n?: number, i?: number): number | null;
}
